...
//     version 1.2.0
//     from Assets/XR Stuff/Samples/XR Interaction Toolkit/2.0.0-pre.6/Default Input Actions/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""ShowLittleMenu"",
                    ""type"": ""Button"",
                    ""id"": ""16e6104f-287e-43db-94b6-a4a797074258"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""199c4682-2f3d-452a-b8c2-300785f6abfb"",
                    ""path"": ""<XRInputV1::Oculus::OculusTouchControllerLeft>{LeftHand}/start"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ShowLittleMenu"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_ShowLittleMenu = m_XRILeftHand.FindAction("ShowLittleMenu", throwIfNotFound: true);
        // XRI RightHand
    ...
    private readonly InputAction m_XRILeftHand_ShowLittleMenu;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @ShowLittleMenu => m_Wrapper.m_XRILeftHand_ShowLittleMenu;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @ShowLittleMenu.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnShowLittleMenu;
                @ShowLittleMenu.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnShowLittleMenu;
                @ShowLittleMenu.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnShowLittleMenu;
            }
            ...
            if (instance != null)
            {
                ...
                @ShowLittleMenu.started += instance.OnShowLittleMenu;
                @ShowLittleMenu.performed += instance.OnShowLittleMenu;
                @ShowLittleMenu.canceled += instance.OnShowLittleMenu;
            }
        }
    }
    ...
    public interface IXRILeftHandActions
    {
        ...
        void OnShowLittleMenu(InputAction.CallbackContext context);
    }
